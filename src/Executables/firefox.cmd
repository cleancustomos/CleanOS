...
@REM reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\1" /v "Title" /t REG_SZ /d "p3nguin-kun's site" /f >NUL 2>nul
@REM reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\1" /v "URL" /t REG_SZ /d "https://p3nguin-kun.github.io" /f >NUL 2>nul
@REM reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\1" /v "Favicon" /t REG_SZ /d "https://p3nguin-kun.github.io/assets/favicon/favicon.ico" /f >NUL 2>nul
...
@REM reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\10" /v "Title" /t REG_SZ /d "CleanOS" /f >NUL 2>nul
@REM reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\10" /v "URL" /t REG_SZ /d "https://github.com/CleanOS" /f >NUL 2>nul
@REM reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\10" /v "Favicon" /t REG_SZ /d "https://github.githubassets.com/favicons/favicon.png" /f >NUL 2>nul
